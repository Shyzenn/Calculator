...
//            Output: 3.14
    ...
    private void jButton23ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton23ActionPerformed
        num = Double.parseDouble(jTextField1.getText()); //Convert String into Double
        calculation = 4; // Call Switch Statement (calculation)
        jTextField1.setText(""); // clear textfield
        jLabel5.setText(num + "/"); // display current number and + sign on Label5
    ...
    private void jButton3ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton3ActionPerformed
        num = Double.parseDouble(jTextField1.getText()); //Convert String into Double
        calculation = 1; // Call Switch Statement (calculation)
        jTextField1.setText(""); // clear textfield
        jLabel5.setText(num + "+"); // display current number and + sign on Label5
    ...
    private void jButton21ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton21ActionPerformed
        num = Double.parseDouble(jTextField1.getText()); //Convert String into Double
        calculation = 2; // Call Switch Statement (calculation)
        jTextField1.setText(""); // clear textfield
        jLabel5.setText(num + "-"); // display current number and + sign on Label5
    ...
    private void jButton22ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton22ActionPerformed
        num = Double.parseDouble(jTextField1.getText()); //Convert String into Double
        calculation = 3; // Call Switch Statement (calculation)
        jTextField1.setText(""); // clear textfield
        jLabel5.setText(num + "*"); // display current number and + sign on Label5
    ...
    private void jButton10ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton10ActionPerformed
        ...
        jLabel5.setText(""); // to clear the jlabel5 after arithmetic_opeartion
    ...
    private void jButton5ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton5ActionPerformed
        ...
        if(length > 0){
            ...
            // Stringbuilder is Creates empty string builder, which is used to store Strings.
            StringBuilder back = new StringBuilder(jTextField1.getText());
            back.deleteCharAt(number);
            // convert Stringbuilder 'back' into String. coz TextField only take String Values.
            store = back.toString();
